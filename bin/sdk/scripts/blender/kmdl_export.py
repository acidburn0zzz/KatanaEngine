...
class Export_MD2(bpy.types.Operator, ExportHelper):
	...
	fCopyTextureSxS = BoolProperty(name="Copy texture(s) next to .model",
							description="default: True",
							default=True)

	fNameTextureToMD2Filename = BoolProperty(name="Name first texture similar to .model",
							description="default: True",
							default=True)
	typesExportFormats = [
				('Junaio', 'LH (Junaio)', 'Export for Junaio'),
				('Katana', 'RH (Katana default)', 'Export for Katana'),
				]

...
//================================================
void SelectBrush_ (int entitynum, int brushnum)
{
	entity_t	*e;
	brush_t		*b;
	int			i;
	...
	case WM_COMMAND: 
		...
		{ 
			case IDOK:
				...
				SelectBrush_ (atoi(entstr), atoi(brushstr));
				EndDialog(hwndDlg, 1);
				return TRUE;
...
/*	TODO:
		DERP, if an entire brush is selected then just
		grab our first texture from the list...
*/
...
//	int			i;
	...
	// [11/8/2012] TODO: Replace when we have something more reliable above ~hogsy
//	for (i=0 ; i<32 ; i++)

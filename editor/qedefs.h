...
#define QE3_STYLE	(WS_POPUP|WS_THICKFRAME|WS_CAPTION|WS_MINIMIZEBOX|WS_MAXIMIZEBOX|WS_CLIPSIBLINGS|WS_CLIPCHILDREN|WS_CHILD)

#define QE_AUTOSAVE_INTERVAL  5       // number of minutes between autosaves

#define	CAMERA_WINDOW_CLASS	"CAMERA"

...
KatanaViewer::KatanaViewer() : mxWindow (0, 0, 0, 0, 0, kAppTitle, mxWindow::Normal)
{
...
void
KatanaViewer::setRenderMode (int mode)
{
	if (mode >= 0)
	{
